...
const CollectionsPage = () => {
  ...
  const { setCurrentTab, setCollectionID } = useContext(AppContext);
  ...
  //   const resCollec = await apiGetSpecificCollection(id, page);
  ...
  const fnFetchCollections = async (page: number) => {
    setLoading(true);
    const resCollec = await apiGetCollections({ page: page });
    console.log("resCollec:", resCollec);
    setAllCollections(resCollec?.data?.message);
