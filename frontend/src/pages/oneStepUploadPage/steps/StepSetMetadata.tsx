...
import { apiGetAssetJSON } from "src/apis/backendApis/UploadAssetsApi";
...
const StepSetMetadata = () => {
  ...
  const { arrImagesS3Links, arrImagesMetadata, setArrImagesMetadata } =
